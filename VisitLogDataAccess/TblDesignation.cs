...
namespace VisitLogDataAccess
{
	...
	public partial class TblDesignation : ActiveRecord<TblDesignation>, IActiveRecord
	{
		...
		public VisitLogDataAccess.TblEmployeeCollection TblEmployeeRecords()
		{
			return new VisitLogDataAccess.TblEmployeeCollection().Where(TblEmployee.Columns.DesisgnationID, DesignationID).Load();
		}
		#endregion
