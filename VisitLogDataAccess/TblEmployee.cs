...
namespace VisitLogDataAccess
{
	...
	public partial class TblEmployee : ActiveRecord<TblEmployee>, IActiveRecord
	{
		...
		{
			return new VisitLogDataAccess.UserLoginCollection().Where(UserLogin.Columns.EmployeeId, EmployeeID).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public VisitLogDataAccess.TblDesignation TblDesignation
		{
			get { return VisitLogDataAccess.TblDesignation.FetchByID(this.DesisgnationID); }
