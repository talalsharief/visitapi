...
namespace VisitLogDataAccess
{
    ...
    public partial class UserLoginController
    {
	    ...
	    public void Insert(string UserName,string Passworrd,string EmailAddress,int UserRoleId,bool IsActive,string UserType,int? EmployeeId,int? Attempt,bool? IsAdmin)
	    {
	    ...
	    public void Update(int UserLoginId,string UserName,string Passworrd,string EmailAddress,int UserRoleId,bool IsActive,string UserType,int? EmployeeId,int? Attempt,bool? IsAdmin)
	    {
		    UserLogin item = new UserLogin();
	        item.MarkOld();
	        item.IsLoaded = true;
