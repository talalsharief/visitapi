...
namespace VisitLogDataAccess
{
	...
	public partial class Product : ActiveRecord<Product>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("product", TableType.Table, DataService.GetInstance("PrimaryProvider"));
				...
				DataService.Providers["PrimaryProvider"].AddSchema("product",schema);
			}
		}
		#endregion
