...
namespace SmartCBSDataAccess{
    /// <summary>
    /// Strongly-typed collection for the VwPMTReading class.
    /// </summary>
    [Serializable]
    public partial class VwPMTReadingCollection : ReadOnlyList<VwPMTReading, VwPMTReadingCollection>
    {        
        public VwPMTReadingCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the VwPMTReadings view.
    /// </summary>
    [Serializable]
    public partial class VwPMTReading : ReadOnlyRecord<VwPMTReading>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("VwPMTReadings", TableType.View, DataService.GetInstance("PrimaryProvider"));
                ...
                colvarPMTReadingID.IsNullable = true;
                ...
                DataService.Providers["PrimaryProvider"].AddSchema("VwPMTReadings",schema);
            }
        }
        #endregion
        ...
        public VwPMTReading(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VwPMTReading(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VwPMTReading(string columnName, object columnValue)
        {
            SetSQLProps();
