...
namespace SmartCBSDataAccess
{
	...
	public partial class UserMenu : ActiveRecord<UserMenu>, IActiveRecord
	{
		...
		public SmartCBSDataAccess.UserMenuCollection ChildUserMenuRecords()
		{
			return new SmartCBSDataAccess.UserMenuCollection().Where(UserMenu.Columns.TopMenuId, UserMenuId).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public SmartCBSDataAccess.UserMenu ParentUserMenu
		{
			get { return SmartCBSDataAccess.UserMenu.FetchByID(this.TopMenuId); }
