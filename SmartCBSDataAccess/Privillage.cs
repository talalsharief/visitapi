...
namespace SmartCBSDataAccess
{
	...
	public partial class Privillage : ActiveRecord<Privillage>, IActiveRecord
	{
		...
		{
			return new SmartCBSDataAccess.TblAssignPrivillageCollection().Where(TblAssignPrivillage.Columns.ViewID, PrivillageId).Load();
		}
		public SmartCBSDataAccess.TblAssignPrivillageCollection TblAssignPrivillageRecordsFromPrivillage()
		{
			return new SmartCBSDataAccess.TblAssignPrivillageCollection().Where(TblAssignPrivillage.Columns.AddID, PrivillageId).Load();
		}
		public SmartCBSDataAccess.TblAssignPrivillageCollection TblAssignPrivillageRecordsFromPrivillageEditID()
		{
			return new SmartCBSDataAccess.TblAssignPrivillageCollection().Where(TblAssignPrivillage.Columns.EditID, PrivillageId).Load();
		}
		public SmartCBSDataAccess.TblAssignPrivillageCollection TblAssignPrivillageRecordsFromPrivillageDeleteID()
		{
			return new SmartCBSDataAccess.TblAssignPrivillageCollection().Where(TblAssignPrivillage.Columns.DeleteID, PrivillageId).Load();
		}
		#endregion
