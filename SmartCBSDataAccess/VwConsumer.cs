...
namespace SmartCBSDataAccess{
    /// <summary>
    /// Strongly-typed collection for the VwConsumer class.
    /// </summary>
    [Serializable]
    public partial class VwConsumerCollection : ReadOnlyList<VwConsumer, VwConsumerCollection>
    {        
        public VwConsumerCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the VwConsumer view.
    /// </summary>
    [Serializable]
    public partial class VwConsumer : ReadOnlyRecord<VwConsumer>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("VwConsumer", TableType.View, DataService.GetInstance("PrimaryProvider"));
                ...
                DataService.Providers["PrimaryProvider"].AddSchema("VwConsumer",schema);
            }
        }
        #endregion
        ...
        public VwConsumer(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VwConsumer(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VwConsumer(string columnName, object columnValue)
        {
            SetSQLProps();
