...
namespace SmartCBSDataAccess
{
    ...
    public partial class TblAssignPrivillageController
    {
	    ...
	    public void Insert(string PageName,int? ViewID,int? AddID,int? EditID,int? DeleteID,bool? IsActive,int? ModuleID,int? DisplayOrder,string TopMenuName,int? TopMenuPrivillageID)
	    {
            ...
            item.TopMenuName = TopMenuName;
            
            item.TopMenuPrivillageID = TopMenuPrivillageID;
	    ...
	    public void Update(int PrivillagePageID,string PageName,int? ViewID,int? AddID,int? EditID,int? DeleteID,bool? IsActive,int? ModuleID,int? DisplayOrder,string TopMenuName,int? TopMenuPrivillageID)
	    {
		    TblAssignPrivillage item = new TblAssignPrivillage();
	        item.MarkOld();
	        item.IsLoaded = true;
