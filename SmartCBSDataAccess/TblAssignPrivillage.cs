	...
	public partial class TblAssignPrivillage : ActiveRecord<TblAssignPrivillage>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				TableSchema.TableColumn colvarTopMenuName = new TableSchema.TableColumn(schema);
				colvarTopMenuName.ColumnName = "TopMenuName";
				colvarTopMenuName.DataType = DbType.AnsiString;
				colvarTopMenuName.MaxLength = 50;
				colvarTopMenuName.AutoIncrement = false;
				colvarTopMenuName.IsNullable = true;
				colvarTopMenuName.IsPrimaryKey = false;
				colvarTopMenuName.IsForeignKey = false;
				colvarTopMenuName.IsReadOnly = false;
				colvarTopMenuName.DefaultSetting = @"";
				colvarTopMenuName.ForeignKeyTableName = "";
				schema.Columns.Add(colvarTopMenuName);
				
				TableSchema.TableColumn colvarTopMenuPrivillageID = new TableSchema.TableColumn(schema);
				colvarTopMenuPrivillageID.ColumnName = "TopMenuPrivillageID";
				colvarTopMenuPrivillageID.DataType = DbType.Int32;
				colvarTopMenuPrivillageID.MaxLength = 0;
				colvarTopMenuPrivillageID.AutoIncrement = false;
				colvarTopMenuPrivillageID.IsNullable = true;
				colvarTopMenuPrivillageID.IsPrimaryKey = false;
				colvarTopMenuPrivillageID.IsForeignKey = true;
				colvarTopMenuPrivillageID.IsReadOnly = false;
				colvarTopMenuPrivillageID.DefaultSetting = @"";
				
					colvarTopMenuPrivillageID.ForeignKeyTableName = "TblAssignPrivillage";
				schema.Columns.Add(colvarTopMenuPrivillageID);
		...
		[XmlAttribute("TopMenuName")]
		[Bindable(true)]
		public string TopMenuName 
		{
			get { return GetColumnValue<string>(Columns.TopMenuName); }
			set { SetColumnValue(Columns.TopMenuName, value); }
		}
		  
		[XmlAttribute("TopMenuPrivillageID")]
		[Bindable(true)]
		public int? TopMenuPrivillageID 
		{
			get { return GetColumnValue<int?>(Columns.TopMenuPrivillageID); }
			set { SetColumnValue(Columns.TopMenuPrivillageID, value); }
		}
		...
		public SmartCBSDataAccess.TblAssignPrivillageCollection ChildTblAssignPrivillageRecords()
		{
			return new SmartCBSDataAccess.TblAssignPrivillageCollection().Where(TblAssignPrivillage.Columns.TopMenuPrivillageID, PrivillagePageID).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public SmartCBSDataAccess.Privillage Privillage
		{
			get { return SmartCBSDataAccess.Privillage.FetchByID(this.ViewID); }
		...
		/// 
		/// </summary>
		public SmartCBSDataAccess.Privillage PrivillageToAddID
		{
			get { return SmartCBSDataAccess.Privillage.FetchByID(this.AddID); }
		...
		/// 
		/// </summary>
		public SmartCBSDataAccess.Privillage PrivillageToEditID
		{
			get { return SmartCBSDataAccess.Privillage.FetchByID(this.EditID); }
		...
		/// 
		/// </summary>
		public SmartCBSDataAccess.Privillage PrivillageToDeleteID
		{
			get { return SmartCBSDataAccess.Privillage.FetchByID(this.DeleteID); }
			set { SetColumnValue("DeleteID", value.PrivillageId); }
		}
		
		
		/// <summary>
		/// Returns a TblAssignPrivillage ActiveRecord object related to this TblAssignPrivillage
		/// 
		/// </summary>
		public SmartCBSDataAccess.TblAssignPrivillage ParentTblAssignPrivillage
		{
			get { return SmartCBSDataAccess.TblAssignPrivillage.FetchByID(this.TopMenuPrivillageID); }
			set { SetColumnValue("TopMenuPrivillageID", value.PrivillagePageID); }
		}
		...
		/// 
		/// </summary>
		public SmartCBSDataAccess.TblModule TblModule
		{
			get { return SmartCBSDataAccess.TblModule.FetchByID(this.ModuleID); }
		...
		/// </summary>
		public static void Insert(string varPageName,int? varViewID,int? varAddID,int? varEditID,int? varDeleteID,bool? varIsActive,int? varModuleID,int? varDisplayOrder,string varTopMenuName,int? varTopMenuPrivillageID)
		{
			...
			item.TopMenuName = varTopMenuName;
			
			item.TopMenuPrivillageID = varTopMenuPrivillageID;
		...
		/// </summary>
		public static void Update(int varPrivillagePageID,string varPageName,int? varViewID,int? varAddID,int? varEditID,int? varDeleteID,bool? varIsActive,int? varModuleID,int? varDisplayOrder,string varTopMenuName,int? varTopMenuPrivillageID)
		{
			TblAssignPrivillage item = new TblAssignPrivillage();
        ...
        public static TableSchema.TableColumn TopMenuNameColumn
        {
        ...
        public static TableSchema.TableColumn TopMenuPrivillageIDColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string TopMenuName = @"TopMenuName";
			 public static string TopMenuPrivillageID = @"TopMenuPrivillageID";
